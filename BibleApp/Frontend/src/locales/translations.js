export const translations = {
  es: {
    ...
    ai_placeholder_no_verses: "Selecciona un versículo o escribe una pregunta para comenzar",
  ...
  en: {
    ...
    ai_placeholder_no_verses: "Select a verse or write a question to begin",
